...
btnc=Button(fg="black",bg="orange",font=('arial',30,'bold'),text="c",command=clear,padx=35,pady=15).grid(row=1,column=3)
...
btnplus=Button(fg="black",bg="orange",font=('arial',30,'bold'),text="+",command=lambda:btn("+"),padx=35,pady=15).grid(row=2,column=3)
...
btnminus=Button(fg="black",bg="orange",font=('arial',30,'bold'),text="-",command=lambda:btn("-"),padx=40,pady=15).grid(row=3,column=3)
...
btnmultiply=Button(fg="black",bg="orange",font=('arial',30,'bold'),text="×",command=lambda:btn("*"),padx=35,pady=15).grid(row=4,column=3)

#row5
btnequal=Button(fg="black",bg="green",font=('arial',30,'bold'),text="=",command=equal,padx=95,pady=15).grid(row=5,column=0,columnspan=2)
btnopen=Button(fg="black",bg="orange",font=('arial',30,'bold'),text="(",command=lambda:btn("("),padx=35,pady=15).grid(row=5,column=2)
btnclose=Button(fg="black",bg="orange",font=('arial',30,'bold'),text=")",command=lambda:btn(")"),padx=40,pady=15).grid(row=5,column=3)
